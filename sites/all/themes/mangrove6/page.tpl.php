...
<link rel="stylesheet" href="<?php print base_path() . $directory ?>/styles/sIFR-screen.css" type="text/css" media="screen" />
<link rel="stylesheet" href="<?php print base_path() .$directory ?>/styles/sIFR-print.css" type="text/css" media="print" />

<!--[if lt IE 7]>
<?php print phptemplate_get_ie_styles(); ?>

<link rel="stylesheet" type="text/css" href="<?php echo $directory ?>/styles_ie6.css" />
<script src="<?php echo base_path() .$directory ?>/scripts/pngfix.js" type="text/javascript" defer></script>
<![endif]-->
...
<script src="<?php print base_path() .$directory ?>/scripts/sifr.js" type="text/javascript"></script>
<script src="<?php print base_path() .$directory ?>/scripts/sifr-config.js" type="text/javascript"></script>
